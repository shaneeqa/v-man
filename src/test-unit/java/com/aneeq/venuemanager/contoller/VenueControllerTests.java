...
class VenueControllerTests {
    ...
    @Test
    void testViewVenueById_VenueNotFound() throws VenueNotFoundException {
    ...
    @Test
    void testViewVenueByName() throws VenueNotFoundException {
    ...
    @Test
    void testViewVenueByName_VenueNotFound() throws VenueNotFoundException {
    ...
    @Test
    void testDeleteVenueById_VenueNotFound() throws VenueNotFoundException {
        doThrow(VenueNotFoundException.class).when(venueService).deleteVenueById(1);
        assertThrows(VenueNotFoundException.class,
                () -> venueService.deleteVenueById(1));
        verify(venueService, times(1)).deleteVenueById(1);
    }
    ...
    @Test
    void testUpdateVenueById_VenueNotFound() throws VenueNotFoundException {
        doThrow(VenueNotFoundException.class).when(venueService).updateVenueById(anyInt(), any());
        assertThrows(VenueNotFoundException.class,
                () -> venueService.updateVenueById(anyInt(), any()));
        verify(venueService, times(1)).updateVenueById(anyInt(), any());
    }
